...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Manam NGO</h4></a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9 register-right" style="margin-top: 40px;left: 80px;">
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist" style="width: 40%;">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="donor-tab" data-toggle="tab" href="#donor" role="tab" aria-controls="donor" aria-selected="false">Donor</a>
                            </li>
                        </ul>
                        <div class="tab-content" id="myTabContent">
                            ...
                            <!-- Inside the tab navigation -->
                            

                        <!-- Inside the tab-content -->
                        <div class="tab-pane fade" id="donor" role="tabpanel" aria-labelledby="donor-tab">
                            <h3 class="register-heading">Register as Donor</h3>
                            <form method="post" action="donor_register.php"> <!-- Change action to the appropriate PHP file -->
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Your Name *" name="donor_name" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Blood Group *" name="blood_group" required/>
                                        </div>
                                        <div class="form-group">
                                            <input type="tel" minlength="10" maxlength="10" name="donor_contact" class="form-control" placeholder="Your Phone *" required/>
                                        </div>
                                    </div>
                                    ...
                                    <input type="submit" class="btnRegister" name="donor_submit" value="Register"/>
                                </div>
                            </form>
                        </div>                  
